...
<qgis version="3.42.0-Münster">
  <identifier>geo_provin2010_1</identifier>
  <parentidentifier></parentidentifier>
  <language>ES</language>
  <type>dataset</type>
  <title>geo_provin2010_1</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link name="Shapefile" type="Local Area Network" url="file://\\MRIVADENEIRA\C$\MaJo_INEC\DPA\SHAPES_LISTADOS_Y_REGISTROS\AÑOS\2012\SHP\nxprovincias" format="" size="" description="" mimeType=""/>
  </links>
  <dates/>
  <fees></fees>
